...
export const SITE_DESCRIPTION = `Full-Stack Developer | Performance Optimization Specialist | Open Source Contributor`;
...
export const QUOTE =
  "Full-Stack Developer | Systems Programmer | Problem Solver";
